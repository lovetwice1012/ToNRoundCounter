...
-- Login Devices / Recent Login History
CREATE TABLE IF NOT EXISTS login_devices (
    ...
    INDEX idx_login_devices_user_time (user_id, logged_in_at),
    INDEX idx_login_devices_device (device_id),
    INDEX idx_login_devices_session (session_id),
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
