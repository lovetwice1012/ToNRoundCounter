...
namespace ToNRoundCounter.Application
{
    public class StateService
    {
        ...
        public void RecordRoundResult(string roundType, string? terrorType, bool survived)
        {
            ...
            {
                _logger?.LogEvent("StateService", () => $"Failed to record round result: {ex.Message}", LogEventLevel.Warning);
            }
        ...
        public void UpdateStat(string name, object value)
        {
            ...
            {
                _logger?.LogEvent("StateService", () => $"Failed to update stat '{name}': {ex.Message}", LogEventLevel.Warning);
            }
